...
class SnakeGame:
    ...
    def snake_init(self):
        dis_from_wall = int(self.board["width"]/4)
        x = randint(dis_from_wall, self.board["width"] - dis_from_wall)
        dis_from_wall = int(self.board["height"] / 4)
        y = randint(dis_from_wall, self.board["height"] - dis_from_wall)
        self.snake = []
