...
class SnakeGame:
    def __init__(self, board_width=20, board_height=20, gui=False):#, ML_algo=None,save_file=None):
        self.score = 0
        self.done = False
    ...
    # def save_move(self, key):
    #     snapshot = [key] + self.snake + self.food
    #     file = open(self.save_file_path, 'wb')
    #     pickle.dumps(snapshot, file)

if __name__ == "__main__":
    gui=True
    # start_learning = str(input("do you want the snake to learn?y/n"))
    # if start_learning == "y":
    #     start_learning = True
    #     with_gui = str(input("do you want gui?y/n"))
    #     if with_gui != "y":
    #         gui = False
