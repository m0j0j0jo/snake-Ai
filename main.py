...
def main_run(model_name, gui=False, number_of_itertion=1):
    ...
    if model_name == modle_names.random_snake:
        ...
        model = Boosting(game, name=model_name.name, mode=model_name.name)
