...
class Boosting(BaseModel):
    ...
    def __init__(self, game: SnakeGame, mode=modle_names.boost_survivor_snake__food_dist__current_food_dist):
        ...
        self.get_data_survivor_snake__food_dist(str(mode.name).replace('boost_', ''))
