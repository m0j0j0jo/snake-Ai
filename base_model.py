...
class BaseModel:
    ...
    def save_model(self):
        ...
        self.model.save_weights('weights/{}_weights.h5'.format(self.name))

    def load_model(self):
        if os.path.exists('weights/{}_weights.h5'.format(self.name)):
            self.model.load_weights('weights/{}_weights.h5'.format(self.name))
